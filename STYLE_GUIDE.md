...
The app is light-theme only. Dark mode was dropped deliberately: the studio iPad
lives under gym lighting and a single high-contrast theme is one less thing to
get wrong mid-session.
